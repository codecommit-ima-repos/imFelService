...
module.exports.invoiceExchangeMegaprintCancel = async (event) => {
    try {
...
NumeroDocumentoAAnular="` + params.invoiceExchange.invoiceExchangeAuthorization + `" 
NITEmisor="` + params.transmitter.transmitterTaxDocument + `" 
IDReceptor="` + params.receiver.receiverTaxDocument + `" 
FechaEmisionDocumentoAnular="` + params.invoiceExchange.invoiceExchangeDate + `" 
FechaHoraAnulacion="` + new Date().toISOString().substring(0, 19) + `.000-06:00" 
MotivoAnulacion="` + params.invoiceExchange.invoiceExchangeComment + `" />
</ns:AnulacionDTE>
</ns:SAT>
