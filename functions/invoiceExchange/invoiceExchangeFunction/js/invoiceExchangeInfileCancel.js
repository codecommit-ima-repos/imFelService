...
module.exports.invoiceExchangeInfileCancel = async (event) => {
    try {
...
<dte:DatosGenerales 
FechaEmisionDocumentoAnular="` + invoiceExchange.invoiceExchangeDate + `" 
...
MotivoAnulacion="` + invoiceExchange.invoiceExchangeComment + `" NITEmisor="` + transmitter.transmitterTaxDocument + `" 
NumeroDocumentoAAnular="` + invoiceExchange.invoiceExchangeAuthorization + `"></dte:DatosGenerales>
</dte:AnulacionDTE>
</dte:SAT>
...
async function getBodyCancelSign(params, xmlBase64) {
    try {
        const jsonInfile = {
            ...
            "archivo": xmlBase64,
            "codigo": params.invoiceExchange.invoiceExchangeCode,
    ...
    try {
        let headers = {
            headers: {
                ...
                'identificador': params.invoiceExchange.invoiceExchangeCode
            }
        };
        return Promise.resolve(headers);
    } catch (error) {
